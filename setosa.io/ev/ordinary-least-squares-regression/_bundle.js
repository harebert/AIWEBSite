  ...
  1: [function (require, module, exports) {
    ...
    var React = require("react"),
      ...
      App = React.createClass({
        ...
        render: function () {
          return React.createElement("div", null, React.createElement("h3", null, "互动式讲解!"), React.createElement("p", null, React.createElement("i", null, "通过旋转盘"), " 你可以调节值。", React.createElement("img", {
            src: "ev/linear-regression/resources/dial-tutorial.gif",
            style: style.tutorialVideo
          })), React.createElement("p", null, React.createElement("i", null, "周围有灰圈的点"), " 可以直接拖动。", React.createElement("img", {
            style: style.tutorialVideo,
            src: "ev/linear-regression/resources/point-tutorial.gif"
          })), React.createElement("p", null, "统计回归基本上是一种从一批现有数据中预测未知数量的方法。例如，假设我们一开始就知道 \"样本人口 \"中一群人的身高和手掌大小，并且我们想找出一种方法，从身高预测不在样本中的人的手掌大小。通过应用OLS（最小二乘线性），我们将得到一个方程，将手的大小--\"自变量 \"作为输入，而将身高--\"因变量 \"作为输出。"), React.createElement("p", null, "下面，OLS（最小二乘线性）是在幕后进行的，以产生回归方程。回归中的常数--即所谓的 \"betas\"--是OLS输出的东西。在这里，beta_1是一个截距；它告诉人们即使手的尺寸为零，身高也会是多少。而β_2是手掌大小的系数；它告诉我们，在手掌大小给定的情况下，我们应该期望某人能长多高。拖动样本数据，看看beta	的变化。"), React.createElement(LeastSquares, {
            key: "least-squares",
            ...
            height: 400,
            betas: this.state.betas
          }), React.createElement("p", null, '在某些时候，你可能会问，"betas是从哪里来的？" 让我们揭开OLS（最小二乘线性）是如何找到其beta的帷幕。'), React.createElement("p", null, "误差是预测和现实之间的差异：真实数据点和回归线之间的垂直距离。OLS关注的是 ", React.createElement("em", null, "方差"), " 它试图找到一条穿过样本数据的线，使误差平方之和最小。下面，平方误差以正方形表示，你的工作是选择betas（回归线的斜率和截距），使所有正方形的总面积（平方误差之和）尽可能的小。这就是OLS!"), React.createElement(RegressionAsNobsModule, {
            points: this.state.leastSquaresPoints,
    ...
    var React = require("react"),
      ...
      LeastSquares3DModule = React.createClass({
        ...
        render: function () {
          ...
          }, React.createElement("p", null, "现在，真正的科学家甚至社会学家很少只用一个自变量做回归，但OLS在更多自变量的情况下效果完全一样。下面是有两个自变量的OLS。不过，现在的误差不是相对于一条线，而是相对于三维空间中的一个平面。所以现在OLS的工作是找到这个平面的方程。前两幅图中显示了通过每个轴的平面的切片。"), React.createElement(LeastSquares, {
          ...
          }, React.createElement("p", null, "通过拖动这些点，你可以看到，当涉及多个变量时，真正的关系可能是非常反直觉的。这就是为什么我们有统计学：让我们对事情没有把握。"), React.createElement("p", null, "下面，看看你是否能选择betas来最小化平方误差之和。"), React.createElement("p", null, "还有许多比OLS更复杂的预测技术，如逻辑回归、加权最小二乘回归、稳健回归和越来越多的非参数方法系列。"), this._renderDials(), React.createElement(LeastSquares, {
