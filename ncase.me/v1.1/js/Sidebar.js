...
function Sidebar(loopy){
	...
	(function(){
		...
		page.addComponent(new ComponentHTML({
			...
			"<hr/><br>"+
			"<span class='mini_button' onclick='publish(\"modal\",[\"submitToGroup\"])'>小组提交作业</span><br><br>"+
			"<span class='mini_button' onclick='javascript:window.location.href=\"http://ai.sfls.cn:5050/seeRelativeStu\"'>查看已批阅的作业</span><br><br>"+
