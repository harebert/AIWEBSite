...
$("#xmlsortSort").click(function () {
  ...
  editor.setValue("SELECT d.deptno,d.dname,d.loc,COUNT(e.empno) mycount,NVL(AVG(e.sal),0) myavg FROM dept d,emp e WHERE d.deptno=e.deptno(+) GROUP BY d.deptno,d.dname,d.loc HAVING AVG(sal)>2000")
	...
	$("#formatSqlDemoAdd").click(function () {
  editor.setValue("INSERT INTO cars (car_plate,checkin_time,checkout_time) VALUES ('沪A123456','2021-11-04 09:59:17','2021-11-04 23:03:09')")
}), 
	$("#formatSqlDemoDel").click(function () {
  editor.setValue("DELETE FROM cars WHERE id=1")
}), 
	$("#formatSqlDemoUpdt").click(function () {
  editor.setValue("UPDATE cars SET checkout_time='2021-11-04 23:03:09' where id=1")
}), 
	$("#formatSqlDemoSel").click(function () {
  editor.setValue("select * from cars")
}), 
