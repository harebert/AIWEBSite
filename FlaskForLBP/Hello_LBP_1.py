...
def uploadLBP():
    ...
    if request.method == 'POST':
        ...
        if filename.split(".")[1].lower()=="png" or filename.split(".")[1].lower()=="jpg":
            ...
            img2ExcelBlack(to_image,os.path.join(basepath,  'static/') +newfilename+"T4.xlsx")
            saveTextFile(newfilename + "B", imBright)
            img2ExcelBlack(imBright, os.path.join(basepath,  'static/') +newfilename + "B.xlsx")
            saveTextFile(newfilename + "D", imDark)
            img2ExcelBlack(imDark, os.path.join(basepath,  'static/') +newfilename + "D.xlsx")
            saveTextFile(newfilename + "f", out)
            img2ExcelBlack(out, os.path.join(basepath,  'static/') +newfilename + "f.xlsx")
    ...
    return render_template('uploadLBP_1.html')
